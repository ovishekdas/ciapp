        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="<?php echo site_url(); ?>" class="site_title"><i class="fa fa-paw"></i> <span>Gentelella Alela!</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="javascript:void(0)"><i class="fa fa-laptop"></i> Listing</a></li>
                </ul>
              </div>
          ...
          <div class="">
            <div class="page-title">
              ...
              <div class="title_right">
				...
				<a href="<?php echo site_url()."welcome/add"; ?>" class="btn btn-primary" type="button"><i class="fa fa-plus"></i> Add</a>
				<!--
